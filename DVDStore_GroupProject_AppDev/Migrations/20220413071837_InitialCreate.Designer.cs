...
namespace DVDStore_GroupProject_AppDev.Migrations
{
    ...
    [Migration("20220413071837_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.Actor", b =>
                {
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.AppUsers", b =>
                {
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.CastMember", b =>
                {
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.DVDCategory", b =>
                {
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.DVDCopy", b =>
                {
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.DVDTitle", b =>
                {
                    b.Property<int>("DVDNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.Loan", b =>
                {
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.LoanType", b =>
                {
                    b.Property<int>("LoanTypeNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.Member", b =>
                {
                    b.Property<int>("MemberNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.MembershipCategory", b =>
                {
                    b.Property<int>("MembershipCategoryNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.Producer", b =>
                {
                    b.Property<int>("ProducerNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.Studio", b =>
                {
                    b.Property<int>("StudioNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.CastMember", b =>
                {
                    b.HasOne("DVDStore_GroupProject_AppDev.Models.Actor", "Actor")
                        .WithMany("CastMember")
                        .HasForeignKey("ActorNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DVDStore_GroupProject_AppDev.Models.DVDTitle", "DVDTitle")
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.DVDTitle", b =>
                {
                    b.HasOne("DVDStore_GroupProject_AppDev.Models.DVDCategory", "DVDCategory")
                        .WithMany("DVDTitle")
                        .HasForeignKey("CategoryNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DVDStore_GroupProject_AppDev.Models.Producer", "Producer")
                        .WithMany("DVDTitles")
                        .HasForeignKey("ProducerNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DVDStore_GroupProject_AppDev.Models.Studio", "Studio")
                        .WithMany("DVDTitles")
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.Loan", b =>
                {
                    b.HasOne("DVDStore_GroupProject_AppDev.Models.DVDCopy", "DVDCopy")
                        .WithMany("Loans")
                        .HasForeignKey("CopyNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DVDStore_GroupProject_AppDev.Models.LoanType", "LoanType")
                        .WithMany("Loans")
                        .HasForeignKey("LoanTypeNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DVDStore_GroupProject_AppDev.Models.Member", "Member")
                        .WithMany("Loans")
            ...
            modelBuilder.Entity("DVDStore_GroupProject_AppDev.Models.Member", b =>
                {
                    b.HasOne("DVDStore_GroupProject_AppDev.Models.MembershipCategory", "MembershipCategory")
                        .WithMany("Members")
